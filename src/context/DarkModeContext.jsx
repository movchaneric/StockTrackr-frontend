...
// Custom hook
/**
 * useDarkMode is a custom hook that provides access to the dark mode state and the function to toggle it.
 *
 * @returns {Object} The current dark mode state and the function to toggle the mode.
 * @throws Will throw an error if used outside of the DarkModeProvider.
 */
